...
<body class="flex items-center justify-center min-h-screen bg-cover bg-center" style="background-image: url('https://4.bp.blogspot.com/-QVa1ZZibEuU/Uq1WXbK5uyI/AAAAAAAABdc/E3gRDa5vpkU/s1600/vegetables.jpg');">
    <div class="bg-blur p-8 rounded-lg shadow-lg max-w-md w-full">
        ...
        <form>
            ...
            <button type="submit" onclick="window.location.href='/penjual/dashboard.html'" class="w-full p-3 rounded-full bg-white text-black font-bold hover:bg-gray-300 transition duration-200">Login</button>
        </form>
        <p class="text-center text-white mt-4">Don't have an account? <a href="/register" class="font-bold text-white">Register</a></p>
    </div>
</body>
</html>
